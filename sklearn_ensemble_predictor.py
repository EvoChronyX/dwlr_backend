"""
High-Accuracy Scikit-Learn Ensemble Model Predictor
Fallback version using only scikit-learn models when XGBoost is incompatible
"""
import pandas as pd
import numpy as np
import joblib
...
class SklearnEnsemblePredictor:
    """
    High-Accuracy Ensemble Model using only scikit-learn models
    Alternative when XGBoost is not available
    """
    ...
    def train_ensemble(self, df: pd.DataFrame) -> Dict[str, float]:
        """
        Train the complete ensemble model using scikit-learn
        Returns training metrics
        """
        print("🚀 Training Scikit-Learn Ensemble Model...")
        ...
        # Random Forest 1: High complexity
        self.models['rf1'] = RandomForestRegressor(
            n_estimators=500,
            max_depth=20,
            min_samples_split=2,
            min_samples_leaf=1,
        ...
        self.models['rf1'].fit(X_train_scaled, y_train)
        
        # Random Forest 2: Medium complexity
        self.models['rf2'] = RandomForestRegressor(
            n_estimators=300,
            max_depth=15,
            min_samples_split=5,
            min_samples_leaf=2,
        ...
        self.models['rf2'].fit(X_train_scaled, y_train)
        ...
        self.models['et'].fit(X_train_scaled, y_train)
        
        print("🌿 Training Gradient Boosting models...")
        
        # Gradient Boosting 1: High learning rate
        self.models['gb1'] = GradientBoostingRegressor(
            n_estimators=300,
            max_depth=8,
            learning_rate=0.1,
            subsample=0.8,
        ...
        self.models['gb1'].fit(X_train_scaled, y_train)
        
        # Gradient Boosting 2: Low learning rate
        self.models['gb2'] = GradientBoostingRegressor(
            n_estimators=500,
            max_depth=6,
            learning_rate=0.05,
            subsample=0.9,
        ...
        self.models['gb2'].fit(X_train_scaled, y_train)
        ...
        # ElasticNet
        self.models['elastic'] = ElasticNet(alpha=0.1, l1_ratio=0.5, random_state=42)
        ...
        print(f"\n🎯 SKLEARN ENSEMBLE MODEL PERFORMANCE:")
        print(f"   R² Score: {r2:.4f}")
        print(f"   MSE: {mse:.4f}")
        print(f"   RMSE: {rmse:.4f}")
        print(f"   MAE: {mae:.4f}")
        print(f"   MAPE: {mape:.2f}%")
        print("✅ Scikit-Learn ensemble training completed!")
    ...
    def save_model(self, filepath: str):
        ...
        print(f"✅ Scikit-Learn ensemble model saved to {filepath}")
    ...
    def load_model(self, filepath: str):
        ...
        print(f"✅ Scikit-Learn ensemble model loaded from {filepath}")
    ...
    def get_model_info(self) -> Dict[str, Any]:
        ...
        return {
            "model_type": "Scikit-Learn Ensemble (RF + ExtraTrees + GB + Ridge Meta-Learner)",
